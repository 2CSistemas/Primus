        ...
        protected override bool GerarRelatorio()
        {
            if (!ExistemErros())
            {
                ...
                if (chbGrupo.Checked && !chbProduto.Checked)
                    ...
                    resultado = produtoEstoqueController.GerarPorGrupoEstoque((GrupoEstoque)lkpGrupoEstoque.Selecionado, cbSituacao.Text, false, ovCMB_StatusEstoque.SelectedIndex, LocalEstoque?.ID);
